    ...
    <div className={`flex flex-col space-y-1.5 ${className}`}>
      ...
      <div className="bg-black/40 border border-white/10 rounded-2xl p-3">
        <input
          ...
          className="w-full bg-black/30 border border-white/10 text-white text-sm rounded-xl px-4 py-3 focus:outline-none focus:ring-1 focus:ring-brand focus:border-brand transition-all placeholder-zinc-700"
        />
          ...
          {filtered.map((opt) => {
            ...
            return (
              <button
                ...
                className={`w-full text-left flex items-start gap-3 px-3 py-2 rounded-xl border transition-colors ${
                  checked
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  {opt.desc && <div className="text-xs text-zinc-500 mt-0.5">{opt.desc}</div>}
                </div>
              </button>
            );
          })}
